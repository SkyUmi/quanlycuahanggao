...
@WebServlet("/newNCCServlet")
public class newNCCServlet extends HttpServlet {
...
Connection conn = null; //connect SQL
    try {
        ...
        NCC n=new NCC(ID,  NameNCC,Type,Address,Email, Sdt); //tạo đối tượng product
    //thêm đối tượng vào CSDL
        DBUtils.insertNCC(conn, n); 
        request.getRequestDispatcher("/NewNCC.jsp").forward(request, response);
