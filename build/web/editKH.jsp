...
<html>
    ...
    <!--<center><h1>Edit Product</h1></center>
        ...
        <style>
            ...
            <form method="POST" action="editKHServlet" id="editproduct">
                            <h1 class="form-heading1">Sửa thông tin khách hàng</h1>
                            <td>ID khách hàng:</td>
                            <div class="form-group1">
                                <td ><input type="hidden" class="form-input1" 
                                       placeholder="KH0XX" name="ID" value="${k.getID()}"/></td>
                            </div> 
                            ...
                            <div class="form-group1">
                                <td><input type="text" class="form-input1" 
                                       placeholder="Nhập tên mới" name="NameKH" value="${k.getNameKH()}"/></td>
                            </div>
                            
                            <td>Mua loại:</td>
                            <div class="form-group1">
                                <td><input type="text" class="form-input1" 
                                       placeholder="Gạo" name="Typebus" value="${k.getTypebus()}"/></td>
                            </div>
                            <td>Tên sp đã mua:</td>
                            <div class="form-group1">
                                <td><input type="text" class="form-input1" 
                                       placeholder="Nàng Hương" name="Buypro" value="${k.getBuypro()}"/></td>
                            </div>
                            <td>Địa chỉ:</td>
                            <div class="form-group1">
                                <td><input type="text" class="form-input1" 
                                       placeholder="4/200 Phạm Ngũ Lão" name="Address" value="${k.getAddress()}"/></td>
                            </div>
                            <td>Email:</td>
                            <div class="form-group1">
                                <td><input type="text" class="form-input1" 
                                       placeholder="abc@gmail.com" name="Email" value="${k.getEmail()}"/></td>
                            </div>
                            ...
                            <div class="form-group1">
                                    <td><input type="text" class="form-input1" 
                                           placeholder="0368945612" name="Sdt" value="${k.getSdt()}"/></td>
                            </div>
                            ...
                            <div>
                                ...
                                <ul class="return">
                                    <li>
                                        <a href="KHListServlet" >Quay lại</a>
                                    </li>
                                </ul>
            </form>
         </div>
