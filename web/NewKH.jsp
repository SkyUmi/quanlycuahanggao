    ...
    <table>
        ...
        <h5>${thongbao}</h5>
         ...
         <div id="wrapper1">
            ...
            <form method="POST" action="newKHServlet"  id="insertproduct">
                            <h1 class="form-heading1">Thêm khách hàng</h1>
                            <td>ID khách hàng:</td>
                            <div class="form-group1">
                                <td><input type="text" class="form-input1" 
                                       placeholder="KH0XX" name="ID"/></td>
                            </div> 
                            ...
                            <div class="form-group1">
                                <td><input type="text" class="form-input1" 
                                       placeholder="Nhập tên khách hàng" name="NameKH"/></td>
                            </div>

                            <td>Mua loại:</td>
                            <div class="form-group1">
                                <td><input type="text" class="form-input1" 
                                       placeholder="Gạo" name="Typebus"/></td>
                            </div>
                            
                            <td>Tên sp mua:</td>
                            <div class="form-group1">
                                    <td><input type="text" class="form-input1" 
                                           placeholder="Nàng Huong" name="Buypro"/></td>
                            </div>
                            <td>Địa chỉ:</td>
                            <div class="form-group1">
                                    <td><input type="text" class="form-input1" 
                            ...
                            <div class="form-group1">
                                    <td><input type="text" class="form-input1" 
                                           placeholder="abc@gmail.com" name="Email"/></td>
                            </div>

                            <td>Sdt:</td>
                            <div class="form-group1">
                                    <td><input type="text" class="form-input1" 
                                           placeholder="0368452150" name="Sdt"/></td>
                            </div>
