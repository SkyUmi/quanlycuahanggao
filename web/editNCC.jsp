...
<html>
    ...
    <!--<center><h1>Edit Product</h1></center>
        ...
        <style>
            ...
            <form method="POST" action="editNCCServlet" id="editproduct">
                            <h1 class="form-heading1">Sửa thông tin nhà cung cấp</h1>
                            <td>ID nhà cung cấp:</td>
                            <div class="form-group1">
                                <td ><input type="hidden" class="form-input1" 
                                       placeholder="NCC0XX" name="ID" value="${n.getID()}"/></td>
                            </div> 
                            ...
                            <div class="form-group1">
                                <td><input type="text" class="form-input1" 
                                       placeholder="Nhập tên mới" name="NameNCC" value="${n.getNameNCC()}"/></td>
                            </div>
                            
                            <td>Cung cấp loại:</td>
                            <div class="form-group1">
                                <td><input type="text" class="form-input1" 
                                       placeholder="Nhập loại" name="Type" value="${n.getType()}"/></td>
                            </div>
                            <td>Địa chỉ:</td>
                            <div class="form-group1">
                                <td><input type="text" class="form-input1" 
                                       placeholder="4/200 Phạm Ngũ Lão" name="Address" value="${n.getAddress()}"/></td>
                            </div> 
                            <td>Email:</td>
                            <div class="form-group1">
                                <td><input type="text" class="form-input1" 
                                       placeholder="abc@gmail.com" name="Email" value="${n.getEmail()}"/></td>
                            </div>
                            ...
                            <div class="form-group1">
                                    <td><input type="text" class="form-input1" 
                                           placeholder="0368945612" name="Sdt" value="${n.getSdt()}"/></td>
                            </div>
